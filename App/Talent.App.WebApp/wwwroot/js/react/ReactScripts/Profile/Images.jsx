...
export class Images extends React.Component {
  ...
  loadImages(Id) {
    ...
    $.ajax({
      url:
        `${profileEndpoint}/profile/profile/getEmployerProfileImage/?id=` + Id,
      headers: {
      ...
      success: function(res) {
        ...
        if (res.employerProfile.length > 0) {
          for (var i = 0; i < res.employerProfile.length; i++) {
            imageSrcArr.push(
              `${profileEndpoint}/profile/profile/getEmployerProfileImages/?Id=` +
  ...
  fileUploadHandler(Id) {
    ...
    $.ajax({
      url: `${profileEndpoint}/profile/profile/addEmployerProfileImages`,
      headers: {
        Authorization: 'Bearer ' + cookies
      },
      type: 'POST',
